...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "col-12 col-md-8 px-0 px-md-3 mt-3 mt-md-0" }, _attrs))}><div class="bg-white rounded p-3 mb-3"> status peserta : Diterima di SDIT Harapan Umat Jember </div><div class="bg-white rounded p-3 mb-3"><p class="fs-4 m-0">Data Pendaftar</p></div><div class="bg-white rounded p-3">`);
