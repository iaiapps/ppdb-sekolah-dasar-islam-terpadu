...
const PanduanHome_vue_vue_type_style_index_0_scoped_3a101854_lang = "";
const _sfc_main$3 = {
  name: "PanduanHome"
};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "panduan",
    class: "bg-container"
  }, _attrs))} data-v-3a101854><div class="container py-md-5 py-4" data-v-3a101854><div class="row" data-v-3a101854><div class="col-12 col-md-5" data-v-3a101854><h3 class="display-6" data-v-3a101854>Panduan Pendaftaran</h3><p class="fs-5" data-v-3a101854> Panduan Pendaftaran Peserta Didik Baru <br data-v-3a101854>SDIT Harapan Umat Jember </p><ul class="fs-5 pb-2" data-v-3a101854><li data-v-3a101854>Buat akun PPDB</li><li data-v-3a101854>Membayar biaya pendaftaran</li><li data-v-3a101854>Konfirmasi pembayaran</li><li data-v-3a101854>Login web dan isi formulir</li><li data-v-3a101854>Pengumuman</li></ul><button class="btn btn-light btn-lg" data-v-3a101854>WA Admin</button></div><div class="col-12 col-md-7 pt-4 pt-md-0" data-v-3a101854><div class="row" data-v-3a101854><div class="col-12 col-md-6 p-2" data-v-3a101854><div class="bg-card-pand p-3" data-v-3a101854><i class="bi bi-coin display-5" data-v-3a101854></i><p data-v-3a101854>Buat Akun PPDB, kemudian membayar biaya pendaftaran sebesar : <span class="bg-oorange text-white p-1 rounded fw-bold" data-v-3a101854>Rp 300.000</span> ke rekening sekolah BSI 4441234007 a.n. Sekolah Dasar Islam Terpadu Harapan Umat Jember. </p></div></div><div class="col-12 col-md-6 p-2" data-v-3a101854><div class="bg-card-pand p-3" data-v-3a101854><i class="bi bi-phone-flip display-5" data-v-3a101854></i><p data-v-3a101854> Mengirim bukti transfer ke nomor 088-289-378-109 dengan format: <br data-v-3a101854><span class="bg-oorange p-1 rounded fw-bold text-white" data-v-3a101854>nama pengirim#nama calon siswa,</span><br data-v-3a101854>agar akun berstatus &quot;Aktif&quot;. </p></div></div><div class="col-12 col-md-6 p-2" data-v-3a101854><div class="bg-card-pand p-3" data-v-3a101854><i class="bi bi-input-cursor-text display-5" data-v-3a101854></i><p data-v-3a101854>Mengisi formulir pendaftaran dengan akun yang sudah &quot;Aktif&quot; di web PPDB SDIT Harum. Akun yang &quot;Belum Aktif&quot; tidak dapat mengisi formulir pendaftaran</p></div></div><div class="col-12 col-md-6 p-2" data-v-3a101854><div class="bg-card-pand p-3" data-v-3a101854><i class="bi bi-envelope-paper display-5" data-v-3a101854></i><p data-v-3a101854>Menunggu pengumuman lanjutan dari sekolah. Yang akan ditampilkan di website PPDB.</p></div></div></div></div></div></div></div>`);
}
...
const PanduanHome = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-3a101854"]]);
