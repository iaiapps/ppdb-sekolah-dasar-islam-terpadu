...
const SetPpdb_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {
  components: {
    Link
  },
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--]--></tbody></table></div><i> NB: Data dan Export yang aktif adalah gelombang yang aktif</i></div></div></div>`);
}
