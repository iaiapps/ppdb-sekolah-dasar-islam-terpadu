...
const FirstHome_vue_vue_type_style_index_0_scoped_aa6d53d3_lang = "";
const _sfc_main$5 = {
  name: "FrstHome",
  components: {
    Link
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Link = resolveComponent("Link");
  _push(`<!--[--><div id="beranda" class="back" data-v-aa6d53d3><div class="container pb-5" data-v-aa6d53d3><div class="row" data-v-aa6d53d3><div class="col-12 col-md-6 pt-md-4 center" data-v-aa6d53d3><div class="pt-3 pt-md-5" data-v-aa6d53d3><h2 class="display-5 bg-dark py-2 px-3 text-white d-inline-block" data-v-aa6d53d3> PENDAFTARAN SDIT </h2><h2 class="display-5 bg-dark py-2 px-3 text-white d-inline-block" data-v-aa6d53d3> HARAPAN UMAT </h2></div><div class="pt-3" data-v-aa6d53d3><p class="fs-3 m-0" data-v-aa6d53d3> Telah dibuka untuk tahun 2023/2024 </p><p class="fs-3" data-v-aa6d53d3>Segera daftar, kuota terbatas!</p></div><div class="pt-3 d-grid gap-2 d-md-block" data-v-aa6d53d3>`);
  _push(ssrRenderComponent(_component_Link, {
  ...
  _push(`<a href="https://wa.me/6288289378109" target="_blank" class="btn btn-outline-dark btn-lg" data-v-aa6d53d3> WA ADMIN </a></div></div><div class="col-12 col-md-6 pt-4 order-first order-md-last d-flex justify-content-center" data-v-aa6d53d3><img class="gbr"${ssrRenderAttr("src", "/storage/img/gbr.png")} alt="gbr" data-v-aa6d53d3></div></div></div></div><div class="text-center bg-dark p-4 p-md-5 text-white top" data-v-aa6d53d3><h3 class="display-5" data-v-aa6d53d3>Sudah punya akun PPDB?</h3><p class="display-6 py-3" data-v-aa6d53d3>Login web disini</p>`);
  _push(ssrRenderComponent(_component_Link, {
...
const FirstHome = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-aa6d53d3"]]);
const JadwalHome_vue_vue_type_style_index_0_scoped_992afff0_lang = "";
const _sfc_main$4 = {};
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "jadwal",
    class: "container"
  }, _attrs))} data-v-992afff0><h3 class="text-center display-4 pt-3 pt-md-5" data-v-992afff0> Jadwal Pendaftaran (Timeline) </h3><div class="row mb-5 text-center" data-v-992afff0><div class="col-6 col-md-4 py-3" data-v-992afff0><div class="p-3 bg-card" data-v-992afff0><img class="img-ket pt-2"${ssrRenderAttr("src", "storage/img/1.png")} data-v-992afff0><h5 class="py-2 fs-3 text-white mb-0" data-v-992afff0> Pendaftaran Calon Peserta Didik </h5><p class="fs-4 py-2 text-black" data-v-992afff0> 12 Sept 2022 s/d 14 Jan 2023 </p><hr class="w-50" data-v-992afff0></div></div><div class="col-6 col-md-4 py-3" data-v-992afff0><div class="p-3 bg-card" data-v-992afff0><img class="img-ket"${ssrRenderAttr("src", "storage/img/2.png")} data-v-992afff0><h5 class="py-2 fs-3 text-white mb-0" data-v-992afff0> Observasi dan <br data-v-992afff0>Psikotest </h5><p class="fs-4 py-2 text-black" data-v-992afff0>11 Februari 2023</p><hr class="w-50 text-center" data-v-992afff0></div></div><div class="col-6 col-md-4 py-3" data-v-992afff0><div class="p-3 bg-card" data-v-992afff0><img class="img-ket"${ssrRenderAttr("src", "storage/img/3.png")} data-v-992afff0><h5 class="py-2 fs-3 text-white mb-0" data-v-992afff0> Pengumuman <br data-v-992afff0>Hasil PPDB </h5><p class="fs-4 py-2 text-black" data-v-992afff0>13 Maret 2023</p><hr class="w-50 text-center" data-v-992afff0></div></div><div class="col-6 col-md-4 py-3" data-v-992afff0><div class="p-3 bg-card" data-v-992afff0><img class="img-ket"${ssrRenderAttr("src", "storage/img/4.png")} data-v-992afff0><h5 class="py-2 fs-3 text-white mb-0" data-v-992afff0> Pembayaran Biaya <br data-v-992afff0>Daftar Ulang </h5><p class="fs-4 py-2 text-black" data-v-992afff0>13 Mar - 27 Mar 2023</p><hr class="w-50 text-center" data-v-992afff0></div></div><div class="col-6 col-md-4 py-3" data-v-992afff0><div class="p-3 bg-card" data-v-992afff0><img class="img-ket"${ssrRenderAttr("src", "storage/img/5.png")} data-v-992afff0><h5 class="py-2 fs-3 text-white mb-0" data-v-992afff0> Test BTAQ &amp; <br data-v-992afff0>Fitting seragam </h5><p class="fs-4 py-2 text-black" data-v-992afff0>11-12 Mei 2023</p><hr class="w-50 text-center" data-v-992afff0></div></div><div class="col-6 col-md-4 py-3" data-v-992afff0><div class="p-3 bg-card" data-v-992afff0><img class="img-ket"${ssrRenderAttr("src", "storage/img/6.png")} data-v-992afff0><h5 class="py-2 fs-3 text-white mb-0" data-v-992afff0> Pembagian seragam &amp; kelas </h5><p class="fs-4 py-2 text-black" data-v-992afff0>7 Juli 2023</p><hr class="w-50 text-center" data-v-992afff0></div></div></div></div>`);
}
...
const JadwalHome = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-992afff0"]]);
