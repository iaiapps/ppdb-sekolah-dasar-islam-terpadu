...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_AppLayout, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="col-md px-0 px-md-3 mt-3 mt-md-0"${_scopeId}><div class="bg-white rounded p-3 mb-3"${_scopeId}><p class="fs-4 m-0"${_scopeId}>Set Cost Category</p></div><div class="bg-white rounded p-3 vh-100"${_scopeId}><table class="table table-responsive"${_scopeId}><thead${_scopeId}><tr${_scopeId}><th${_scopeId}>kategory</th><th${_scopeId}>Jk</th><th${_scopeId}>Gedung</th><th${_scopeId}>Perpus</th><th${_scopeId}>Kegiatan</th><th${_scopeId}>Buku &amp; Media</th><th${_scopeId}>Seragam</th><th${_scopeId}>Jilbab</th><th${_scopeId}>IPP</th><th${_scopeId}>Total</th></tr></thead><tbody${_scopeId}><!--[-->`);
        ...
        return [
          createVNode("div", { class: "col-md px-0 px-md-3 mt-3 mt-md-0" }, [
            ...
            createVNode("div", { class: "bg-white rounded p-3 vh-100" }, [
