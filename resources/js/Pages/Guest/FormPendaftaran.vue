<template>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-md-4 bg-oorange p-3 p-md-5">
                <div class="text-left">
                    <img
                        :src="'/storage/img/gbr.png'"
                        class="img"
                        alt="logoppdb"
                    />
                </div>
                ...
                <form @submit.prevent="kirimFormulir">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="school_origin"
                                    >Asal TK</label
                                >
                                <input
                                    class="form-control"
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="special_needs"
                            ...
                            <div class="mb-3">
                                ...
                                <select
                                    class="form-select"
                                    id="saudara_kandung_di_sdit"
                                    name="saudara_kandung_di_sdit"
                            ...
                            <hr />
                            <div class="mb-3">
                                <label class="form-label" for="living"
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="dad"
                                    >Nama Ayah</label
                                >
                                <input
                                    class="form-control"
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="dad_edu"
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="dad_occupation"
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="dad_phone"
                                    >Nomor Telpon Ayah</label
                                >
                                <input
                                    class="form-control"
                                    id="dad_phone"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="mom"
                                    >Nama Ibu</label
                                >
                                <input
                                    class="form-control"
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="mom_edu"
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="mom_occupation"
                                    >Pekerjaan Ibu</label
                                >
                                <select
                                    class="form-select"
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="mom_phone"
                                    >Nomor Telpon Ibu</label
                                >
                                <input
                                    class="form-control"
                                    id="mom_phone"
