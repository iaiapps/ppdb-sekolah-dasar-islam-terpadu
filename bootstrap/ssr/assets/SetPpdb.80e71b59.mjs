...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="table-responsive bg-white rounded p-3 position-relative mb-3"><div class="mb-5"><p class="fs-5">Setting PPDB</p><hr><table class="table table-striped"><thead><tr><th scope="col">Tahun ajaran</th><th scope="col">Gelombang</th><th scope="col">isActive</th><th scope="col">Action</th></tr></thead><tbody><!--[-->`);
