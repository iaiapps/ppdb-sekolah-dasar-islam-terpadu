...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($props.sets, (set) => {
    _push(`<tr><td>${ssrInterpolate(set.key)}</td><td>${ssrInterpolate(set.value)}</td><td><a${ssrRenderAttr("href", _ctx.route("ppdb.edit", set.id))} class="btn btn-sm btn-oorange">Edit</a></td></tr>`);
  });
