<template>
    <div id="panduan" class="bg-container">
        <div class="container py-md-5 py-4">
            <div class="row">
                <div class="col-12 col-md-5">
                    <h3 class="display-6">Panduan Pendaftaran</h3>
                    <p class="fs-5">
                        Panduan Pendaftaran Peserta Didik Baru
                        <br />SDIT Harapan Umat Jember
                    </p>
                    <ul class="fs-5 pb-2">
                        <li>Membuat akun PPDB</li>
                        <li>Membayar biaya pendaftaran</li>
                        <li>Konfirmasi pembayaran</li>
                        <li>Login web dan isi formulir</li>
                        <li>Pengumuman</li>
                    </ul>
                    <button class="btn btn-light btn-lg">WA Admin</button>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 p-2">
                            <div class="bg-card-pand p-3">
                                ...
                                <p>
                                    Membuat Akun PPDB, kemudian membayar biaya
                                    pendaftaran sebesar :
                                    <span
                        ...
                        <div class="col-12 col-md-6 p-2">
                            <div class="bg-card-pand p-3">
                                ...
                                <p>
                                    Mengirim bukti transfer ke nomor
                                    088-289-378-109 dengan format:
                                    <br />
                                    <span
                        ...
                        <div class="col-12 col-md-6 p-2">
                            <div class="bg-card-pand p-3">
                                <i
                                    class="bi bi-input-cursor-text display-5"
                                ></i>
                                <p>
                                    Mengisi formulir pendaftaran dengan akun
                                    yang sudah "Aktif" di web PPDB SDIT Harum.
                                    Akun yang "Belum Aktif" tidak dapat mengisi
