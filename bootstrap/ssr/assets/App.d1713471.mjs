...
const Sidebar_vue_vue_type_style_index_0_scoped_2b728d97_lang = "";
const _sfc_main$2 = {
  name: "LeftSide",
  props: {
    admin: Boolean
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_Link = resolveComponent("Link");
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "col-12 p-3 bg-white rounded col-md-2" }, _attrs))} data-v-2b728d97><div class="text-center" data-v-2b728d97><img class="logo"${ssrRenderAttr("src", "/storage/img/logosdit.png")} alt="logo" data-v-2b728d97></div><p class="text-center mt-3 py-2 fs-6 text-dark fw-bold" data-v-2b728d97>${ssrInterpolate(_ctx.$page.props.auth.user.name)}</p>`);
  if (_ctx.$page.props.auth.user.roles == "admin") {
    _push(`<ul class="nav flex-row flex-md-column justify-content-between" data-v-2b728d97><li class="nav-item my-1" data-v-2b728d97>`);
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi-bar-chart me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Home</span>`);
        } else {
          return [
    ...
    _push(`</li><li class="nav-item my-1" data-v-2b728d97>`);
    _push(ssrRenderComponent(_component_Link, {
      class: ["nav-link hover rounded", {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi-info-circle me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Users</span>`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi-info-circle me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Students</span>`);
        } else {
          return [
            createVNode("i", { class: "bi bi-info-circle me-0 me-md-2" }),
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi-coin me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Cost Category</span>`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi-cash-coin me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Set Cost</span>`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi bi-sliders me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Setting</span>`);
        } else {
          return [
  ...
  if (_ctx.$page.props.auth.user.roles == "menunggu" || _ctx.$page.props.auth.user.roles == "diterima") {
    _push(`<ul class="nav flex-row flex-md-column justify-content-around" data-v-2b728d97><li class="nav-item my-1" data-v-2b728d97>`);
    _push(ssrRenderComponent(_component_Link, {
      class: ["nav-link hover rounded", {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi-house-door me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Home</span>`);
        } else {
          return [
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<i class="bi bi-info-circle me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Informasi</span>`);
        } else {
          return [
            createVNode("i", { class: "bi bi-info-circle me-0 me-md-2" }),
    ...
    if (_ctx.$page.props.auth.user.roles == "menunggu") {
      _push(`<li class="nav-item my-1" data-v-2b728d97>`);
      _push(ssrRenderComponent(_component_Link, {
        class: ["nav-link hover rounded", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="bi bi-calendar3 me-0 me-md-2" data-v-2b728d97${_scopeId}></i><span class="d-none d-md-inline-block" data-v-2b728d97${_scopeId}>Jadwal Test</span>`);
          } else {
            return [
...
const Sidebar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-2b728d97"]]);
